...
public class YamlPropertyConfigurationFile extends YamlConfigurationFile implements PropertyConfiguration {
    ...
    @Override
    public void setProperty(@NotNull String name, @NotNull String property, @Nullable String server,
    ...
    @Override
    public String[] getProperty(@NotNull String name, @NotNull String property, @Nullable String server,
            @Nullable String world)
    {
        ...
        if ((value = getObject(
                new String[]
                { PER_WORLD, TAB.getInstance().getConfiguration().getGroup(worldGroups, world), name,
                        property })) != null)
        {
        ...
        if ((value = getObject(
                new String[]
                { PER_WORLD, TAB.getInstance().getConfiguration().getGroup(worldGroups, world),
                        TabConstants.DEFAULT_GROUP, property })) != null)
        {
        ...
        if ((value = getObject(
                new String[]
                { PER_SERVER, TAB.getInstance().getConfiguration().getServerGroup(serverGroups, server), name,
                        property })) != null)
        {
        ...
        if ((value = getObject(
                new String[]
                { PER_SERVER, TAB.getInstance().getConfiguration().getServerGroup(serverGroups, server),
                        TabConstants.DEFAULT_GROUP, property })) != null)
        {
    ...
    public void remove(@NotNull String name) {
        ...
        getConfigurationSection(PER_SERVER).keySet()
