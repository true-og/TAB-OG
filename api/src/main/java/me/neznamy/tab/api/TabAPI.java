...
public abstract class TabAPI {
     ...
     * {@code IllegalStateException}. This is usually caused by shading the API into
     * own project, which is not allowed. Another option is calling the method
    ...
    /**
     * Returns collection of all online players. Will return empty list if plugin is
     * disabled (due to a broken configuration file for example).
     *
    ...
    /**
     * Return BossBar manager instance if the feature is enabled. If not, returns
     * {@code null}.
     *
    ...
    /**
     * Returns scoreboard manager instance if the feature is enabled. If not,
     * returns {@code null}.
     *
    ...
    /**
     * Returns team manager instance if the feature is enabled. If not, returns
     * {@code null}.
     *
     * @return team manager
     */
    ...
    /**
     * Returns header/footer manager instance if the feature is enabled. If not,
     * returns {@code null}.
     *
    ...
    /**
     * Returns TabList name format manager instance if the feature is enabled. If
    ...
    /**
     * Returns Layout manager instance if the feature is enabled. If not, returns
     * {@code null}.
     *
    ...
    /**
     * Returns Sorting manager instance if at least one feature capable of sorting
     * players is enabled. If not, returns {@code null}.
     *
