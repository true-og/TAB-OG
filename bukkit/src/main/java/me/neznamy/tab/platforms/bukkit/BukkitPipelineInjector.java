...
public class BukkitPipelineInjector extends NettyPipelineInjector {
    ...
    public static void tryLoad() {
        ...
        try {
            ...
            getChannel = player -> (Channel) CHANNEL
                    .get(NETWORK_MANAGER.get(PLAYER_CONNECTION.get(getHandle.invoke(player.getPlayer()))));
    ...
    /**
     * Returns {@code true} if pipeline injection is available, {@code false} if
     * not.
     *
