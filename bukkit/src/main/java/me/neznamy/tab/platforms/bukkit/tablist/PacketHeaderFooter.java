...
/**
 * Header/footer sender that uses NMS to send packets. Available on all versions
 * since 1.8 when the feature was added into the game.
 */
public class PacketHeaderFooter {
    ...
    /**
     * Constructs new instance and loads all NMS content. Throws exception if
     ...
     *
     * @param player Player to send header/footer to.
