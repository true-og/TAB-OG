...
/**
 * Interface for managing player sorting by directly configuring team names of
 * players. Instance can be obtained using {@link TabAPI#getSortingManager()}.
 * If the feature is disabled, it will return {@code null}.
 */
@SuppressWarnings("unused") // API class
public interface SortingManager {

    /**
     * Forces new team name for the player until this method is called again with
     * null argument and performs all actions to change player's team name
     *
     * @param player   player to set team name of
     ...
     *
     * @param player player to check forced team name of
     ...
     *
     * @param player Player to get team name of
