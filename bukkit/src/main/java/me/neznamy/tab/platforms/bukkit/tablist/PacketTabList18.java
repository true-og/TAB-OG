...
public class PacketTabList18 extends TabListBase<Object> {
    ...
    public static void load() throws ReflectiveOperationException {
        ...
        PlayerInfoClass = BukkitReflection.getClass("network.protocol.game.ClientboundPlayerInfoUpdatePacket",
                "network.protocol.game.ClientboundPlayerInfoPacket", "network.protocol.game.PacketPlayOutPlayerInfo",
            ...
            throws ReflectiveOperationException
    {
        ...
        gameModes = new Object[] { Enum.valueOf(gameMode, "SURVIVAL"), Enum.valueOf(gameMode, "CREATIVE"),
                Enum.valueOf(gameMode, "ADVENTURE"), Enum.valueOf(gameMode, "SPECTATOR") };
    ...
    public void addEntry0(@NonNull UUID id, @NonNull String name, @Nullable Skin skin, boolean listed, int latency,
            int gameMode, @Nullable Object displayName)
    {
    ...
    public void onPacketSend(@NonNull Object packet) {
        ...
        for (Object nmsData : (List<?>) PLAYERS.get(packet)) {
            ...
            if (action.equals(Action.UPDATE_LATENCY.name()) || action.equals(Action.ADD_PLAYER.name())) {
                ...
                int latency = TAB.getInstance().getFeatureManager().onLatencyChange(player, id,
                        PlayerInfoData_Latency.getInt(nmsData));
