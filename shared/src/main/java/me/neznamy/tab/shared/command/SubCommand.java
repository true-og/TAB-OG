...
public abstract class SubCommand {
    ...
    @Getter
    @Setter
    private static List<String> allProperties = Arrays.asList(TabConstants.Property.TABPREFIX,
            TabConstants.Property.TABSUFFIX, TabConstants.Property.TAGPREFIX, TabConstants.Property.TAGSUFFIX,
            TabConstants.Property.CUSTOMTABNAME, TabConstants.Property.ABOVENAME, TabConstants.Property.BELOWNAME,
            TabConstants.Property.CUSTOMTAGNAME);

    // properties that require unlimited NameTag mode
    protected final List<String> extraProperties = Arrays.asList(TabConstants.Property.ABOVENAME,
            TabConstants.Property.BELOWNAME, TabConstants.Property.CUSTOMTAGNAME);
    ...
    public boolean hasPermission(@Nullable TabPlayer sender, @Nullable String permission) {
        ...
        if (sender == null)
            return true; // console
        if (sender.hasPermission(TabConstants.Permission.COMMAND_ALL))
            return true;
    ...
    public @NotNull List<String> getStartingArgument(@NotNull Collection<String> values, @NotNull String argument) {
        ...
        return values.stream().filter(value -> value.toLowerCase().startsWith(argument.toLowerCase()))
