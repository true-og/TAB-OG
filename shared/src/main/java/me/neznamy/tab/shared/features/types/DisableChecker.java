...
public class DisableChecker extends TabFeature implements Refreshable {
     ...
     *
     * @param featureName      Name of feature this condition is for
     * @param disableCondition Configured condition for disabling the feature
     * @param action           Action to take on condition change
     * @param field            Function that returns field storing disable status
     */
    ...
    public void refresh(@NotNull TabPlayer refreshed, boolean force) {
        ...
        if (disabledNow == value.get())
            return; // Condition result did not change, only placeholders inside
