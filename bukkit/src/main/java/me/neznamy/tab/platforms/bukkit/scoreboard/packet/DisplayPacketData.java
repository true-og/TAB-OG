...
public class DisplayPacketData {
     ...
     *
     * @throws ReflectiveOperationException If something fails
     */
    public DisplayPacketData() throws ReflectiveOperationException {

        Class<?> ScoreboardObjective = BukkitReflection.getClass("world.scores.Objective",
                "world.scores.ScoreboardObjective", "ScoreboardObjective");
        DisplayObjectiveClass = BukkitReflection.getClass("network.protocol.game.ClientboundSetDisplayObjectivePacket", // Mojang
                                                                                                                        // mapped
     ...
     * @param objective Objective to display
    ...
    /**
     * Checks if packet is display objective packet and forwards it to enabled
     * features.
     *
     * @param player Player who received packet
