...
/**
 * A class representing the n.m.s.DataWatcher class to make work with it much
 * easier
 */
@ToString
public class DataWatcher implements EntityData {
    ...
    private static final int armorStandFlagsPosition = EntityData
            .getArmorStandFlagsPosition(BukkitReflection.getMinorVersion());
    ...
    public static void load() throws ReflectiveOperationException {
        ...
        if (BukkitReflection.is1_19_3Plus()) {
            ...
            Class<?> dataWatcher$Item = BukkitReflection.getClass("network.syncher.SynchedEntityData$DataValue",
            ...
            DataWatcher = BukkitReflection.getClass("network.syncher.SynchedEntityData", "network.syncher.DataWatcher",
                    "DataWatcher");
            if (minorVersion >= 7) {
            ...
            if (minorVersion >= 9) {
                ...
                Class<?> dataWatcherSerializer = BukkitReflection.getClass("network.syncher.EntityDataSerializer",
                        "network.syncher.DataWatcherSerializer", "DataWatcherSerializer");
                DataWatcher_register = ReflectionUtils.getMethod(DataWatcher,
                        new String[]
                        { "define", "register", "a", "m_135372_" }, // {Mojang, Bukkit, Bukkit 1.18+, Mohist 1.18.2}
                        dataWatcherObject, Object.class);
                newDataWatcherObject = dataWatcherObject.getConstructor(int.class, dataWatcherSerializer);

            } else {

                DataWatcher_register = ReflectionUtils
                        .getMethod(DataWatcher, new String[]
                        { "func_75682_a", "a" }, int.class, // {Thermos 1.7.10, Bukkit}
                                Object.class);
    ...
    private static void loadSerializers() throws ReflectiveOperationException {
        ...
        DataWatcherSerializer_BYTE = ReflectionUtils.getField(dataWatcherRegistry, "BYTE", "a", "f_135027_").get(null); // Mohist
                                                                                                                        // 1.18.2
        ...
        if (BukkitReflection.is1_19_3Plus()) {
            ...
            DataWatcherSerializer_OPTIONAL_COMPONENT = ReflectionUtils
                    .getField(dataWatcherRegistry, "OPTIONAL_COMPONENT", "g").get(null);
            ...
            if (BukkitReflection.getMinorVersion() >= 13) {
                ...
                DataWatcherSerializer_OPTIONAL_COMPONENT = ReflectionUtils
                        .getField(dataWatcherRegistry, "OPTIONAL_COMPONENT", "f", "f_135032_").get(null); // Mohist
                                                                                                          // 1.18.2
                DataWatcherSerializer_BOOLEAN = ReflectionUtils
                        .getField(dataWatcherRegistry, "BOOLEAN", "i", "f_135035_").get(null); // Mohist 1.18.2
     ...
     * @param serializer Object serializer (1.9+)
     * @param value      value
     */
    ...
    /**
     * Writes entity custom name with position based on server version and value
     * depending on client version (RGB or not)
     *
