...
public class Permissions extends SortingType {
    ...
    /**
     * Constructs new instance with given parameters and registers internal
     * permission placeholders.
     *
     * @param sorting Sorting feature
     * @param options Permission nodes separated with ","
     */
    ...
    public String getChars(@NotNull TabPlayer p) {
        ...
        for (String permission : sortedGroups.keySet()) {
            ...
            if (p.hasPermission(permission)) {
                ...
                p.sortingData.teamNameNote += "\n-> Highest sorting permission: &e" + permission + " &a(#" + position
                        + " in list). &r";
