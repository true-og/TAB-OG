...
public interface Layout {
     ...
     * @param slot Slot (1-80)
     * @param text Text to display
     * @param skin Skin definition like in config
     */
     ...
     * Adds a player group.
     *
     * @param condition Condition that must be met for player to appear in the
     *                  group. May be null for no requirement. Syntax is like in
     *                  config - either condition name or short format.
     * @param slots     Slots for this player group
     */
