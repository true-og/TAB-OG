...
public class PacketSender {
    ...
    /**
     * Constructs new instance and attempts to load required classes, fields and
     * methods. If something fails, error is thrown.
     *
    ...
    /**
     * Sends packet to specified player. If something goes wrong, throws an
     * exception.
     *
