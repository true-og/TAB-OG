...
/**
 * A class handling numeric conditions to avoid repeated number parsing for
 * static numbers and therefore reduce memory allocations and improve
 * performance.
 */
public class NumericCondition extends SimpleCondition {

    /**
     * {@code true} if left side is a static number, {@code false} if it has
     * placeholders
     */
    ...
    /**
     * {@code true} if right side is a static number, {@code false} if it has
     * placeholders
     */
    ...
    /**
     * Returns left side of this condition. If it's a static number it is returned,
     * if not, placeholders are replaced and then text parsed and returned.
     *
     * @param p player to get left side for
    ...
    /**
     * Returns right side of this condition. If it's a static number it is returned,
     * if not, placeholders are replaced and then text parsed and returned.
     *
     * @param p player to get right side for
    ...
    /**
     * Parses double in given string and returns it. Returns second argument if
     * string is not valid and prints a console warn.
     *
     * @param placeholder  Raw placeholder, used in error message
     * @param output       string to parse
     * @param defaultValue value to return if string is not valid
     * @param player       Player name used in error message
     * @return parsed double or {@code defaultValue} if input is invalid
     */
    public double parseDouble(@NotNull String placeholder, @NotNull String output, double defaultValue,
            TabPlayer player)
    {
