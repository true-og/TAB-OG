...
public class PacketHeaderFooter {
    ...
    public PacketHeaderFooter() throws ReflectiveOperationException {
        ...
        Class<?> HeaderFooterClass = BukkitReflection.getClass(
        ...
        if (BukkitReflection.getMinorVersion() >= 17) {
            ...
            Field HEADER =
                    ReflectionUtils.getFields(HeaderFooterClass, Component).get(0);
            Field FOOTER =
                    ReflectionUtils.getFields(HeaderFooterClass, Component).get(1);
