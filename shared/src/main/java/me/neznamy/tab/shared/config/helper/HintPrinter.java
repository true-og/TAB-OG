...
/**
 * Class for printing hints for a cleaner configuration with the same effect,
 * typically due to redundancy.
 */
@SuppressWarnings("unchecked")
public class HintPrinter {

    /**
     * Checks header/footer config section if any of per-world or per-server values
     * are identical to default value and prints a hint if it is.
     *
     * @param configSection Header/footer config section
     */
    ...
    /**
     * Prints a hint saying layout already includes prevent-spectator-effect
     * feature.
     */
    ...
    /**
     * Prints a hint that a placeholder was configured for refresh interval, but the
     * interval is identical to default interval, therefore there is no need to
     * define it.
     *
     * @param placeholder Defined placeholder with same refresh as default
     */
    ...
    /**
     * Prints a hint when placeholder replacement is configured to show the
     * placeholder itself in "else" value, which is already the default behavior.
     *
     * @param replacementMap Placeholder output replacement map from config
     */
