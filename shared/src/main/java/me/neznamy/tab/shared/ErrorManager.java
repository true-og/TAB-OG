...
/**
 * An error assistant to print internal errors into error file and warn user
...
public class ErrorManager {
    ...
    /**
     * anti-override.log file when some plugin or server itself attempts to override
     * the plugin
     */
    @Getter
     ...
     *
     * @param dataFolder Data folder for error files
     */
     ...
     *                       or not
     * @param file           file to print error to
     */
     ...
     * @param nested Whether this throwable is nested or not
     ...
     * @param file           file to print error to
     */
    public synchronized void printError(@Nullable String message, @NotNull List<String> error, boolean intoConsoleToo,
            @NotNull File file)
    {
    ...
    /**
     * Prints error message thrown by placeholder and stack trace into
     * placeholder-errors.log file
     *
     * @param message message to print
     * @param t       thrown error
     */
     ...
     *
     * @param message message to print
     * @param t       thrown stack trace elements
     */
    ...
    /**
     * Prints error message and stack trace into errors.log file as well as the
     * console
     *
     * @param message message to print
     * @param t       thrown error
    ...
    /**
     * Prints error message when permission plugin throws error when retrieving
     * group.
     *
     * @param pluginName Name of permission plugin
     * @param player     Player whose group failed to retrieve
     * @param t          Thrown error
     */
     ...
     *
     * @param pluginName Name of permission plugin
     * @param player     Player who null group was returned for
     */
     ...
     *
     * @param placeholder Placeholder input that threw the error
     * @param target      Player the placeholder was parsed for
     * @param t           Thrown error
     */
    public void parseCommandError(@NotNull String placeholder, @NotNull TabPlayer target, @NotNull Throwable t) {

        printError("Placeholder " + placeholder + " threw an exception when parsing for player " + target.getName(), t,
                true, errorLog);
     ...
     *
     * @param id Skin that failed to download
     * @param t  Thrown error
     */
     ...
     *
     * @param name Player name that failed to download
     * @param t    Thrown error
     */
     ...
     *
     * @param texture Texture that failed to download
     * @param t       Thrown error
     */
    ...
    /**
     * Prints error message if armor stand manager of player is unexpectedly
     * {@code null}.
     *
     * @param player Player with null armor stand manager
     * @param action Action during which armor stand manager was null
     */
    ...
    public void mysqlConnectionFailed(@NotNull Throwable t) {
        ...
        printError("Failed to connect to MySQL: " + root.getClass().getName() + ": " + root.getMessage(),
     ...
     *
     * @param event      Event that threw errors
     * @param exceptions Errors thrown
     */
    public void errorFiringEvent(@NotNull TabEvent event, @NotNull Collection<Throwable> exceptions) {

        printError("Some errors occurred whilst trying to fire event " + event, Collections.emptyList(), false,
                errorLog);
        int i = 0;
