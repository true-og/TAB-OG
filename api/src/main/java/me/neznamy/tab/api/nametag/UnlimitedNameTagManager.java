 ...
 * <p>
 * Instance can be obtained using {@link TabAPI#getNameTagManager()} and then
 * casting it. This requires both Team and Unlimited name tag features to be
 * enabled in config, otherwise the method will return {@code null} or not be an
...
public interface UnlimitedNameTagManager extends NameTagManager {
    ...
    /**
     * Disables armor stands of specified player and displays vanilla name tags
     * instead.
     *
     * @param player Player to disable armor stands of
     ...
     *
     * @param player Player to enable back
    ...
    /**
     * Changes name to specified value. Set to {@code null} to reset back to
     * original value.
     *
     * @param player     Player to change name of
     * @param customName New name, or {@code null} to reset to original value
     */
    void setName(@NonNull TabPlayer player, @Nullable String customName);

    /**
     * Changes line to specified value. Set to {@code null} to reset back to
     * original value.
     *
     * @param player Player to change line of
     * @param line   Name of defined line
     * @param value  Value to use, or {@code null} to reset back to original value
     * @see #getDefinedLines()
     */
    ...
    /**
     * Returns custom line value set using
     * {@link #setLine(TabPlayer, String, String)}.
     *
     * @param player Player to check
     * @param line   Defined line
     * @return Custom name set previously or {@code null} if not set
     * @see #setName(TabPlayer, String)
     * @see #getDefinedLines()
     */
