...
public interface TabExpansion {
     ...
     *
     * @param player  Player to set placeholder value for
     * @param visible Whether scoreboard is visible or not
     */
     ...
     *
     * @param player Player to set placeholder value for
     * @param name   Name of currently visible scoreboard
     */
     ...
     *
     * @param player  Player to set placeholder value for
     * @param visible Whether bossbar is visible or not
     */
     ...
     *
     * @param player     Player to set placeholder value for
     * @param previewing Whether player is previewing nametag or not
     */
     ...
     *
     * @param player  Player to set placeholder value for
     * @param visible Whether player wants to see nametags or not
     */
     ...
     *
     * @param player      Player to set placeholder value for
     * @param placeholder Identifier of internal placeholder
     ...
     * @param player   Player to set placeholder value for
     * @param property Name of property
     * @param value    Raw value of property
     */
