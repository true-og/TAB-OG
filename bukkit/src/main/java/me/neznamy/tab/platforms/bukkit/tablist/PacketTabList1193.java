...
public class PacketTabList1193 extends PacketTabList18 {
    ...
    public static void loadNew() throws ReflectiveOperationException {
        ...
        Class<?> RemoteChatSession$Data =
                BukkitReflection.getClass("network.chat.RemoteChatSession$Data", "network.chat.RemoteChatSession$a");
        Class<Enum> EnumGamemodeClass =
                (Class<Enum>) BukkitReflection.getClass("world.level.GameType", "world.level.EnumGamemode");
        ...
        newPlayerInfoData = playerInfoDataClass.getConstructor(
                UUID.class,
                GameProfile.class,
                boolean.class,
                int.class,
        ...
        actionToEnumSet.put(
                Action.UPDATE_GAME_MODE, EnumSet.of(Enum.valueOf(ActionClass, Action.UPDATE_GAME_MODE.name())));
    ...
    public void updateListed(@NonNull UUID entry, boolean listed) {
        packetSender.sendPacket(
                player.getPlayer(), createPacket(Action.UPDATE_LISTED, entry, "", null, listed, 0, 0, null));
    }
    ...
    public Object createPacket(
        ...
        PLAYERS.set(
                packet,
                Collections.singletonList(newPlayerInfoData.newInstance(
                        id,
