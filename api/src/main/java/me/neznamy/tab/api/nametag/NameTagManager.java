 ...
 * <p>
 * Instance can be obtained using {@link TabAPI#getNameTagManager()}. This
 * requires the Team feature to be enabled in config, otherwise the method will
 * return {@code null}.
 */
...
public interface NameTagManager {
     ...
     *
     * @param player player to hide name tag of
     ...
     *
     * @param player player to hide name tag of
     * @param viewer player to hide name tag for
     */
     ...
     *
     * @param player player to show name tag of
     ...
     *
     * @param player player to check name tag visibility status of
     * @return Whether player has hidden NameTag or not
     * @see #hideNameTag(TabPlayer)
     * @see #showNameTag(TabPlayer)
     */
     ...
     *
     * @param player player to check visibility status of
    ...
    /**
     * Unregisters player's team and no longer handles it, as well as disables
     * anti-override for teams. This can be resumed using resumeTeamHandling(). If
     * team handling was paused already, nothing happens.
     *
     * @param player player to pause team handling of
     */
    void pauseTeamHandling(@NonNull TabPlayer player);

    /**
     * Resumes team handling if it was before paused using pauseTeamHandling(), if
     * not, nothing happens
     *
     * @param player player to resume team handling of
     */
    void resumeTeamHandling(@NonNull TabPlayer player);

    /**
     * Returns true if team handling is paused for this player using
     * pauseTeamHandling(), false if not, or it was resumed already using
     * resumeTeamHandling
     *
     * @param player player to check handling status of
     * @return true if paused, false if not
     */
    boolean hasTeamHandlingPaused(@NonNull TabPlayer player);

    /**
     * Forces collision rule for the player. Setting it to null will remove forced
     * value
     *
     * @param player    player to set collision rule of
     * @param collision forced collision rule
     */
    void setCollisionRule(@NonNull TabPlayer player, @Nullable Boolean collision);

    /**
     * Returns forced collision rule or null if collision is not forced using
     * setCollisionRule
     *
     * @param player player to get forced collision of
    ...
    /**
     * Changes player's prefix to provided value. Supports placeholders, as well as
     * any supported RGB formats. Use {@code null} to reset value back to original.
     *
     * @param player player to change prefix of
    ...
    /**
     * Changes player's suffix to provided value. Supports placeholders, as well as
     * any supported RGB formats. Use {@code null} to reset value back to original.
     *
     * @param player player to change prefix of
     ...
     *
     * @param player Player to get custom prefix of
     ...
     *
     * @param player Player to get custom suffix of
     ...
     * 
     * @param player Player to get original prefix of
     ...
     * 
     * @param player Player to get original suffix of
    ...
    /**
     * Toggles name tag visibility view on all players for specified player. On
     * first call, name tags of all players will become invisible for specified
     * player. On second call, they will become visible again.
     *
     * @param player            player to toggle name tag visibility view for
     * @param sendToggleMessage {@code true} if configured toggle message should be
     *                          sent, {@code false} if not
     */
