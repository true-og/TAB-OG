 ...
 * <p>
 * Instance can be obtained using {@link TabAPI#getTabListFormatManager()}. This
 * requires the feature to be enabled in config, otherwise the method will
 * return {@code null}.
 */
...
public interface TabListFormatManager {
    ...
    /**
     * Changes player's name to provided value. Supports placeholders, as well as
     * any supported RGB formats. Use {@code null} to reset value back to original.
     *
     * @param player     player to change prefix of
     * @param customName new customName value
    ...
    /**
     * Returns custom name assigned using {@link #setName(TabPlayer, String)}
     * method. If the method was not used, {@code null} is returned.
     *
     * @param player player to get custom name of
    ...
    /**
     * Returns player's original prefix applied using plugin's internal logic. This
     * value is not affected by API calls in any way.
     *
    ...
    /**
     * Returns player's original name applied using plugin's internal logic. This
     * value is not affected by API calls in any way.
     *
     * @param player player to get original name of
    ...
    /**
     * Returns player's original suffix applied using plugin's internal logic. This
     * value is not affected by API calls in any way.
     *
