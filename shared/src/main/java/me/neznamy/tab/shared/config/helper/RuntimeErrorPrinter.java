...
/**
 * Logger for runtime errors from poor configuration causing the plugin to not
 * work as expected.
 */
public class RuntimeErrorPrinter {

    /**
     * Logs a warning if placeholder did not return a valid number for bossbar
     * progress.
     *
     * @param bossBar         Bossbar where progress is configured
     * @param output          Output after parsing placeholders in configured value
     * @param configuredValue Value configured for the bossbar
     * @param player          Player who the parsing failed for
     */
            ...
            @NotNull String configuredValue, @NotNull TabPlayer player)
    {
        ...
        // Placeholders are not initialized, because bridge did not respond yet
        // (typically on join)
     ...
     *
     * @param type        Numeric sorting type where value is used
     * @param placeholder Configured sorting placeholder
     * @param output      Output returned by the placeholder
     * @param player      Player the placeholder returned output for
     */
     ...
     *
     * @param placeholder Configured placeholder
     * @param output      Output returned by the placeholder
     * @param player      Player the output was received for
     */
    public void invalidNumberForCondition(@NotNull String placeholder, @NotNull String output,
    ...
    public void invalidNumberForBelowName(@NotNull TabPlayer target, @NotNull String configuredValue,
    ...
    public void invalidNumberForPlayerlistObjective(@NotNull TabPlayer target, @NotNull String configuredValue,
            @NotNull String output)
    {
    ...
    public void floatInPlayerlistObjective(@NotNull TabPlayer target, @NotNull String configuredValue,
            @NotNull String output)
    {
     ...
     *
     * @param list   Configured sorting list
     * @param group  Player's group
     * @param player Player with the group
     */
    public void groupNotInSortingList(@NotNull Collection<String> list, @NotNull String group,
            @NotNull TabPlayer player)
    {
    ...
    /**
     * Logs a warning if player does not have any of the defined sorting
     * permissions.
     *
     * @param list   Configured permissions
     * @param player Player with none of the permissions
     */
     ...
     *
     * @param placeholder Configured sorting placeholder
     * @param list        Configured predefined values
     * @param output      Output of the placeholder
     * @param player      Player with the output
     */
