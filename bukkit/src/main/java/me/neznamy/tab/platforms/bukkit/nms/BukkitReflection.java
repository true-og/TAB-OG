...
public class BukkitReflection {
    ...
    @Getter
    private static final boolean is1_19_3Plus = ReflectionUtils
            .classExists("net.minecraft.network.protocol.game.ClientboundPlayerInfoUpdatePacket");

    /** Flag determining whether the server version is at least 1.19.4 or not */
    @Getter
    private static final boolean is1_19_4Plus = ReflectionUtils
            .classExists("net.minecraft.network.protocol.game.ClientboundBundlePacket");
    ...
    @Getter
    private static final boolean is1_20_3Plus = ReflectionUtils
            .classExists("net.minecraft.network.protocol.game.ClientboundResetScorePacket");
    ...
    /**
     * Returns class with given potential names in same order. For 1.17+ it takes
     * packaged class names without "net.minecraft." prefix, for <1.17 it takes
     * class name only.
     *
     ...
     *
     * @param name Package and name of the class
