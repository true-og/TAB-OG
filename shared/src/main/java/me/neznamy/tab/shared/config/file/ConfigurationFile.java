...
public abstract class ConfigurationFile {
    ...
    /**
     * Constructs new instance and attempts to load specified configuration file. If
     * file does not exist, default file is copied from {@code source}.
     *
     * @param source      Source to copy file from if it does not exist
     * @param destination File destination to use
     ...
     * @throws IOException              if I/O operation with the file unexpectedly
     *                                  fails
     */
     ...
     *
     * @param path         Path to the option with sections separated with
     *                     "{@code .}"
     * @param defaultValue Value to be inserted and returned if option is not
     *                     present
    ...
    public Object getObject(@NonNull String path, @Nullable Object defaultValue) {
        ...
        if (value == null && defaultValue != null) {
            ...
            TAB.getInstance().debug("Inserting missing config option \"" + path + "\" with value \"" + defaultValue
                    + "\" into " + file.getName());
            set(path, defaultValue);
            return defaultValue;
     ...
     *
     * @param path Path to the option with sections separated with "{@code .}"
    ...
    private Object getIgnoreCase(@NonNull Map<Object, Object> map, @NonNull String key) {
        ...
        try {
            ...
            // Map modified by another thread during iteration (such as running /tab group
            // or /tab player)
    ...
    /**
     * Returns config option with specified path as {@code String}. Returns
     * {@code null} if option is not present.
     *
     * @param path Path to the option with sections separated with "{@code .}"
    ...
    /**
     * Returns config option with specified path as {@code String}. If the option is
     * not present and {@code defaultValue} is not {@code null}, value is inserted,
     * {@link #save()} called and {@code defaultValue} returned.
     *
     * @param path         Path to the option with sections separated with
     *                     "{@code .}"
     * @param defaultValue Value to be inserted and returned if option is not
    ...
    /**
     * Returns config option with specified path as {@code List<String>}. Returns
     * {@code null} if option is not present.
     *
     * @param path Path to the option with sections separated with "{@code .}"
     * @return value from file or null if not present
    ...
    /**
     * Returns config option with specified path as {@code List<String>}. If the
     * option is not present and {@code defaultValue} is not {@code null}, value is
     * inserted, {@link #save()} called and {@code defaultValue} returned.
     *
     * @param path         Path of the option with sections separated with
     *                     "{@code .}"
     * @param defaultValue Value to be inserted and returned if option is not
     *                     present
    ...
    /**
     * Returns config option with specified path as {@code Integer}. Returns
     * {@code null} if option is not present.
     *
     * @param path Path to the option with sections separated with "{@code .}"
     * @return value from file or null if not present
    ...
    /**
     * Returns config option with specified path as {@code Integer}. If the option
     * is not present and {@code defaultValue} is not {@code null}, value is
     * inserted, {@link #save()} called and {@code defaultValue} returned.
     *
     * @param path         Path to the option with sections separated with
     *                     "{@code .}"
    ...
    /**
     * Returns config option with specified path as {@code Boolean}. If the option
     * is not present and {@code defaultValue} is not {@code null}, value is
     * inserted, {@link #save()} called and {@code defaultValue} returned.
     *
     * @param path         Path to the option with sections separated with
    ...
    /**
     * Returns config option with specified path as {@code Double}. If the option is
     * not present and {@code defaultValue} is not {@code null}, value is inserted,
     * {@link #save()} called and {@code defaultValue} returned.
     *
     * @param path         Path to the option with sections separated with
     ...
     * is not present or value is not a {@code Map}, new empty {@code Map} is
     * returned.
     *
     * @param path Path to the option with sections separated with "{@code .}"
    ...
    /**
     * Returns {@code true} if the file has option with specified path,
     * {@code false} if not.
     *
     * @param path Path to the option with sections separated with "{@code .}"
    ...
    /**
     * Sets value to the specified path and saves the file to disk by calling
     * {@link #save()}.
     *
     * @param path  Path to the option with sections separated with "{@code .}"
    ...
    /**
     * Sets value to the specified map with specified path and value. This is an
     * internal method that correctly creates maps to separate sections using
     * "{@code .}".
     *
     * @param map   Map to insert value to
     * @param path  Path to the option with sections separated with "{@code .}"
     * @param value Value to save
    ...
    /**
     * Returns the real key name without case sensitivity from map. If not found,
     * inserted key is returned.
     *
     * @param map Map to check keys of
    ...
    /**
     * Inserts header back into file. This is required after calling
     * {@link #save()}, because it destroys the header.
     *
     * @throws IOException if I/O operation fails
     */
     ...
     *
     * @param key   Map key
     * @param value Value to insert if missing
     */
