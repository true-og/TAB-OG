...
/**
 * An enum containing all possible legacy color codes and magic codes. Also
 * contains handy color-related methods.
 */
@Getter
public enum EnumChatFormat {
    ...
    LIGHT_PURPLE('d', 0xFF55FF), YELLOW('e', 0xFFFF55), WHITE('f', 0xFFFFFF), OBFUSCATED('k', 0), BOLD('l', 0),
    STRIKETHROUGH('m', 0), UNDERLINE('n', 0), ITALIC('o', 0), RESET('r', 0);
    ...
    private static final ComponentCache<String, EnumChatFormat> lastColorCache = new ComponentCache<>(1000,
            (string, version) -> lastColorsOf0(string));
     ...
     * @param rgb       hex code of the color
     */
    ...
    /**
     * Returns enum value based on provided character or null if character is not
     * valid
     *
    ...
    /**
     * Returns enum value of last colors used in given string. If it's null, empty
     * or does not contain color codes, WHITE is returned.
     *
    ...
    /**
     * Color translation method taken from bukkit, which converts '&amp;' symbol
     * into the actual color character if followed by a valid color character.
     *
     ...
     *
     * @param text text to revert colors in
     ...
     * @return last colors used in provided text or empty string if nothing was
     *         found
     */
