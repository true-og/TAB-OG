...
/**
 * Class for manipulating entity view. Used by unlimited nametags and 1.8
 * bossbar.
 */
public interface EntityView {
     ...
     * @param data       Entity metadata
     */
    void spawnEntity(int entityId, @NotNull UUID id, @NotNull Object entityType, @NotNull Location location,
    ...
    /**
     * Returns {@code true} if given packet is entity destroy packet, {@code false}
     * if not.
     *
     * @param packet Packet to check
     * @return {@code true} if packet is entity destroy packet, {@code false} if
     *         not.
     */
    boolean isDestroyPacket(@NotNull Object packet);

    /**
     * Returns {@code true} if given packet is entity teleport packet, {@code false}
     * if not.
     *
     * @param packet Packet to check
     * @return {@code true} if packet is entity teleport packet, {@code false} if
     *         not.
     */
    boolean isTeleportPacket(@NotNull Object packet);

    /**
     * Returns {@code true} if given packet is spawn player packet, {@code false} if
     * not.
     *
     * @param packet Packet to check
    ...
    /**
     * Returns {@code true} if given packet is entity move packet, {@code false} if
     * not.
     *
     * @param packet Packet to check
    ...
    /**
     * Returns {@code true} if given packet is entity look packet, {@code false} if
     * not.
     *
     * @param packet Packet to check
     ...
     *
     * @param teleportPacket Entity teleport packet
     ...
     *
     * @param movePacket Entity move packet
     * @return Entity id from packet
     */
     ...
     *
     * @param playerSpawnPacket Entity spawn packet
     * @return Entity id from packet
     */
     ...
     *
     * @param destroyPacket Entity destroy packet
     ...
     *
     * @param bundlePacket Bundle packet (1.19.4+)
     ...
     *
     * @param movePacket Packet to get difference from
     ...
     * @param moveDiff Relative position difference
     */
