...
public class BukkitUtils {
    ...
    /**
     * Whether compatibility exceptions should be printed or not, enabling when
    ...
    /**
     * Returns online players from Bukkit API. This requires reflection, as return
     * type changed in 1.8, and we want to avoid errors.
     *
     ...
     *
     * @param exception       Exception thrown when initializing fields, if
     *                        applicable
     * @param failedCheck     Check that failed
     * @param fallback        Fallback implementation, if available
     * @param missingFeatures Features that will be broken because of the
     *                        incompatibility
     */
    ...
    /**
     * Sends a message asking user to update the plugin if some compatibility issue
     * was found.
     */
    public static void sendCompatibilityMessage() {
        ...
        Bukkit.getConsoleSender().sendMessage(EnumChatFormat.RED + "[TAB] Please update the plugin to "
                ...
                + "was made for " + ProtocolVersion.V1_5.getFriendlyName() + " - "
