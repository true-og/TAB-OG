        ...
        TAB.getInstance().getCPUManager().runTask(() -> {
            ...
            try {
                ...
                while (crs.next()) {
                    ...
                    groupFile.setProperty(crs.getString("group"), crs.getString("property"), crs.getString("server"),
                            crs.getString("world"), crs.getString("value"));
                ...
                while (crs.next()) {
                    ...
                    userFile.setProperty(crs.getString("user"), crs.getString("property"), crs.getString("server"),
                            crs.getString("world"), crs.getString("value"));
        ...
        for (String name : file.getAllEntries()) {
            ...
            for (Map.Entry<String, Map<String, Object>> world : file.getPerWorldSettings(name).entrySet()) {
                ...
                for (Map.Entry<String, Object> property : world.getValue().entrySet()) {
                    ...
                    mysqlTable.setProperty(name, property.getKey(), null, world.getKey(),
            ...
            for (Map.Entry<String, Map<String, Object>> server : file.getPerServerSettings(name).entrySet()) {
                ...
                for (Map.Entry<String, Object> property : server.getValue().entrySet()) {
                    ...
                    mysqlTable.setProperty(name, property.getKey(), server.getKey(), null,
                            toString(property.getValue()));
