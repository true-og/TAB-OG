...
public abstract class TabListBase<C> extends TabList<BukkitTabPlayer, C> {
    ...
    public static void findInstance() {
        ...
        try {
            ...
            BukkitUtils.compatibilityError(e, "tablist entry management", "Bukkit API", "Layout feature will not work",
                    "Prevent-spectator-effect feature will not work", "Ping spoof feature will not work",
    ...
    public void setPlayerListHeaderFooter0(@NonNull Object header, @NonNull Object footer) {
        ...
        if (headerFooter != null)
            headerFooter.set(player, header, footer);
    ...
    /**
     * Returns player's skin. If NMS fields did not load or server is in offline
     * mode, returns {@code null}.
     *
