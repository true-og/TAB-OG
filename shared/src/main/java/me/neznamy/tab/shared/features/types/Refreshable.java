...
public interface Refreshable {
     ...
     *
     * @param refreshed Player which a placeholder changed value for
     * @param force     Whether refresh should be forced
     */
    void refresh(@NotNull TabPlayer refreshed, boolean force);

    /**
     * Returns display name of {@link #refresh(TabPlayer, boolean)} called for this
     * feature in /tab cpu
     *
     ...
     *
     * @param placeholder placeholder to add as used in this feature
     */
