...
public class BukkitTabExpansion extends PlaceholderExpansion implements TabExpansion {
    ...
    @NotNull
    private final List<String> placeholders = Collections.unmodifiableList(Arrays.asList("%tab_tabprefix%",
            "%tab_tabsuffix%", "%tab_tagprefix%", "%tab_tagsuffix%", "%tab_customtabname%", "%tab_customtagname%",
            "%tab_belowname%", "%tab_abovename%", "%tab_tabprefix_raw%", "%tab_tabsuffix_raw%", "%tab_tagprefix_raw%",
            "%tab_tagsuffix_raw%", "%tab_customtabname_raw%", "%tab_customtagname_raw%", "%tab_belowname_raw%",
            "%tab_abovename_raw%", "%tab_scoreboard_name%", "%tab_scoreboard_visible%", "%tab_bossbar_visible%",
            "%tab_nametag_preview%", "%tab_nametag_visibility%", "%tab_replace_<placeholder>%",
    ...
    public String onPlaceholderRequest(@Nullable Player player, @NotNull String identifier) {
        ...
        if (identifier.startsWith("replace_")) {
            ...
            do {
                ...
                for (String placeholder : TAB.getInstance().getPlaceholderManager().detectPlaceholders(text)) {
                    ...
                    text = text.replace(placeholder, TAB.getInstance().getPlaceholderManager()
        ...
        if (identifier.startsWith("placeholder_")) {
            ...
            TAB.getInstance().getPlaceholderManager().addUsedPlaceholder(
