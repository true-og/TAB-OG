...
/**
 * Class for hooking into ViaVersion to get protocol version of players to adapt
 * visuals for best experience respecting limits of individual versions.
 */
public class ViaVersionHook {
     ...
     * @param playerName    Player's name for debug messages
     * @param serverVersion Server version to return if Via is not installed or
    ...
    public int getPlayerVersion(@NotNull UUID player, @NotNull String playerName, int serverVersion) {
        ...
        try {
            ...
            // java.lang.IllegalArgumentException: ViaVersion has not loaded the platform
            // yet
