...
public class MySQLGroupConfiguration implements PropertyConfiguration {
    ...
    private void setProperty0(
            ...
            @Nullable String value) {
        if (world != null) {
            perWorld.computeIfAbsent(world, w -> new HashMap<>())
    ...
    public String[] getProperty(
            @NotNull String group, @NotNull String property, @Nullable String server, @Nullable String world) {
        String lowercaseGroup = group.equals(TabConstants.DEFAULT_GROUP) ? group : group.toLowerCase(Locale.US);
        Object value;
        if ((value = perWorld.getOrDefault(world, new HashMap<>())
                        .getOrDefault(lowercaseGroup, new HashMap<>())
                        .get(property))
                != null) {
            return new String[] {toString(value), String.format("group=%s,world=%s", lowercaseGroup, world)};
        }
        if ((value = perWorld.getOrDefault(world, new HashMap<>())
                        .getOrDefault(TabConstants.DEFAULT_GROUP, new HashMap<>())
                        .get(property))
                != null) {
        ...
        if ((value = perServer
                        .getOrDefault(server, new HashMap<>())
                        .getOrDefault(lowercaseGroup, new HashMap<>())
                        .get(property))
                != null) {
        ...
        if ((value = perServer
                ...
                != null) {
            return new String[] {
                toString(value), String.format("group=%s,server=%s", TabConstants.DEFAULT_GROUP, server)
            };
        }
        ...
        if ((value = values.getOrDefault(TabConstants.DEFAULT_GROUP, new HashMap<>())
                        .get(property))
                != null) {
