 ...
 * {@link ScoreboardManager#createScoreboard(String, String, List)}, for
 * scoreboards from config {@link ScoreboardManager#getRegisteredScoreboards()}.
 */
...
public interface Scoreboard {
     ...
     * scoreboards from config use name they were defined with. This value is used
     * internally and in /tab announce scoreboard command.
     *
     ...
     * refresh intervals defined in config. No need to call this method to try to
     * keep placeholders up to date. Supports RGB codes using any of the supported
     * formats.
     * <p>
     ...
     *
     * @param title New title to use with placeholder support
     * @see #getTitle()
     */
    void setTitle(@NonNull String title);

    /**
     * Returns list of lines in this scoreboard in the order they appear in game
     * (first line is on top). This list should only be used for reading, for
     * adding/removing lines see {@link #addLine(String)} and
     * {@link #removeLine(int)}.
     *
     ...
     *
     * @param index Index of line to remove, starting at 0
     * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0
     *                                   || index &gt;= {@link #getLines()}.size())
     * @see #getLines()
     * @see #addLine(String)
     */
